        ...
        <div class="min-h-screen bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center relative overflow-hidden">
            ...
            <div class="bg-white/95 backdrop-blur-sm p-10 rounded-3xl shadow-2xl w-full max-w-md mx-4 z-10 border border-white/20">
                <div class="text-center mb-8">
                    <img src="logo.jpeg" alt="SIPena Logo" class="w-20 h-20 rounded-full mx-auto mb-4 shadow-lg object-cover">
                    <h2 class="text-3xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Login Admin</h2>
                    <p class="text-gray-600 mt-2">Masuk ke SIPena</p>
                </div>
                ...
                <form @submit.prevent="handleLogin">
                    ...
                    <button type="submit" class="w-full bg-gradient-to-r from-primary to-accent text-white font-bold py-3 px-4 rounded-xl hover:shadow-lg transition transform hover:scale-[1.02] flex items-center justify-center gap-2">
                ...
                <div class="mt-6 text-center">
                    <router-link to="/" class="text-primary hover:text-accent transition flex items-center justify-center gap-2">
