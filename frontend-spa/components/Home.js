        ...
        <div class="min-h-screen bg-gradient-to-br from-primary via-secondary to-accent flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <nav class="absolute top-0 w-full bg-white/10 backdrop-blur-md p-4 text-white flex justify-between items-center shadow-lg z-10">
                <div class="flex items-center gap-3 ml-4">
                    ...
                    <h1 class="text-xl font-bold">SIPena</h1>
                </div>
                <router-link to="/login" class="bg-accent text-dark px-6 py-2 rounded-full font-bold hover:bg-yellow-500 transition shadow-lg mr-4 flex items-center gap-2">
            ...
            <div class="text-center bg-white/95 backdrop-blur-sm p-12 rounded-3xl shadow-2xl w-11/12 max-w-3xl mt-16 z-10 border border-white/20">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-6">SIPena (Sistem inventaris peralatan pramuka)</h2>
                ...
                <router-link to="/login" class="bg-gradient-to-r from-primary to-accent text-white px-8 py-4 rounded-full font-bold shadow-lg hover:shadow-xl transition transform hover:scale-105 inline-flex items-center gap-2">
