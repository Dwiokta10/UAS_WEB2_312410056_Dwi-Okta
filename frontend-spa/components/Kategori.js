const Kategori = {
    template: `
        <div class="min-h-screen bg-background flex">
            <!-- Sidebar -->
            <aside class="w-64 bg-gradient-to-b from-primary to-secondary text-white shadow-xl fixed h-full">
                <div class="p-6 border-b border-white/10">
                    <div class="flex items-center gap-3">
                        <img src="logo.jpeg" alt="SIPena Logo" class="w-10 h-10 rounded-lg object-cover">
                        <div>
                            <h1 class="font-bold text-lg">SIPena</h1>
                            <p class="text-xs text-gray-400">Sistem inventaris peralatan pramuka</p>
                        </div>
                    </div>
                </div>
                ...
                <nav class="p-4">
                    ...
                    <router-link to="/kategori" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-accent/20 text-accent font-medium mb-2">
            ...
            <main class="flex-1 ml-64 p-8">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <button @click="openModal()" class="bg-gradient-to-r from-primary to-accent text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition transform hover:scale-105 flex items-center gap-2">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in kategori" :key="item.id" class="border-b border-gray-100 hover:bg-gray-50 transition">
                                    <td class="p-4">
                                        <span class="bg-gradient-to-r from-primary to-accent text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">
                                            {{ index + 1 }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="p-4 text-center">
                                        <button @click="editData(item)" class="bg-gradient-to-r from-accent to-yellow-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:shadow-lg transition mr-2 flex items-center gap-1 inline-flex">
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
                        ...
                        <form @submit.prevent="saveData" class="p-6">
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button type="submit" class="px-6 py-3 bg-gradient-to-r from-primary to-accent text-white rounded-xl font-medium hover:shadow-lg transition flex items-center gap-2">
