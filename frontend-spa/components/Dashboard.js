    ...
    template: `
        <div class="min-h-screen bg-background flex">
            ...
            <aside class="w-64 bg-gradient-to-b from-primary to-secondary text-white shadow-xl fixed h-full">
                ...
                <nav class="p-4">
                    <router-link to="/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-accent/20 text-accent font-medium mb-2">
            ...
            <main class="flex-1 ml-64 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition">
                        <div class="flex items-center justify-between mb-4">
                            <div class="w-12 h-12 bg-gradient-to-br from-success to-green-600 rounded-xl flex items-center justify-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="text-gray-600">
                        <p class="flex items-center gap-3 py-3 border-b border-gray-100">
                            ...
                            Selamat datang di panel admin SIPena. Gunakan menu di samping untuk mengelola inventaris.
                        </p>
                    </div>
                </div>
            </main>
