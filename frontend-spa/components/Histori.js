        ...
        <div class="min-h-screen bg-background flex">
            ...
            <aside class="w-64 bg-gradient-to-b from-primary to-secondary text-white shadow-xl fixed h-full">
                ...
                <nav class="p-4">
                    ...
                    <router-link to="/histori" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-accent/20 text-accent font-medium mb-2">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr v-for="item in histori" :key="item.id" class="border-b border-gray-100 hover:bg-gray-50 transition">
                                    ...
                                    <td class="p-4">
                                        <span class="px-3 py-1 rounded-full text-sm font-bold" :class="item.jenis_transaksi === 'Masuk' ? 'bg-success/20 text-success' : 'bg-red-100 text-red-600'">
